...
export const ROUTE_SCENARIOS: SearchScenario[] = [
  { id: 'start_enrollment', keywords: ['enroll', 'enrol', 'start enrollment', 'start enrolment', 'sign up', 'join plan', '401k enrollment', '401k enrolment'], queries: ['Start enrolment', 'How to enrol?'], subtitle: 'Enrolment', type: 'navigation', route: '/enrollment/plan' },
  { id: 'enrollment_status', keywords: ['enrollment status', 'enrolment status', 'am i enrolled', 'already enrolled'], queries: ['Check enrolment status'], subtitle: 'Enrolment', type: 'navigation', route: '/enrollment/plan' },
  { id: 'resume_enrollment', keywords: ['continue enrollment', 'continue enrolment', 'resume enrollment', 'resume enrolment', 'finish enrollment', 'finish enrolment'], queries: ['Continue enrolment'], subtitle: 'Enrolment', type: 'navigation', route: '/enrollment/plan' },
  { id: 'auto_increase', keywords: ['auto increase', 'automatic escalation', 'annual increase'], queries: ['Turn on automatic contribution increases'], subtitle: 'Enrolment', type: 'navigation', route: '/enrollment/auto-increase' },
...
export const FAQ_SCENARIOS: SearchScenario[] = [
  { id: 'enrollment_time', keywords: ['how long enrollment', 'how long enrolment', 'enrollment take', 'enrolment take'], queries: ['How long does enrolment take?'], subtitle: 'Quick answer', type: 'ai', quickAnswer: 'Usually about 5–15 minutes if you already know things like your beneficiaries — a bit longer if you\'re deciding investments as you go.' },
  { id: 'mandatory_enrollment', keywords: ['mandatory enrollment', 'mandatory enrolment', 'required to enroll', 'required to enrol'], queries: ['Is enrolment mandatory?'], subtitle: 'Quick answer', type: 'ai', quickAnswer: 'It really depends on your employer. Some plans auto-enrol you or expect participation; your SPD or HR can tell you what applies to you.' },
  { id: 'auto_enrollment', keywords: ['auto enroll', 'auto enrol', 'automatic enrollment', 'automatic enrolment'], queries: ['Am I automatically enrolled?'], subtitle: 'Quick answer', type: 'ai', quickAnswer: 'A lot of companies start new hires at a default savings rate unless you opt out — worth confirming in your welcome packet or plan site.' },
  ...
  { id: 'enrollment_deadline', keywords: ['deadline', 'enroll by', 'enrol by'], queries: ['When is the enrolment deadline?'], subtitle: 'Quick answer', type: 'ai', quickAnswer: 'Every employer sets this differently — HR or your enrolment kit is the quickest way to get the real date.' },
